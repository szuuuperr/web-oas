...
class ReportController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('logistik.reports', compact(
            'transactions',
            'materialSummary',
            'totalMasuk',
            'totalKeluar',
    ...
    {
        // This will be implemented when the export libraries are installed
        // For now, return a message
        return back()->with('info', 'Fitur export akan tersedia setelah library diinstall.');
    }
}
