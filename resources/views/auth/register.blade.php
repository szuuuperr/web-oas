            ...
            <div class="login-card rounded-xl border border-surface-container-highest overflow-hidden">
                ...
                <div class="p-8 md:p-12">
                    ...
                    <div class="mb-10 text-center">
                        ...
                        <p class="text-on-surface-variant font-medium text-sm">Industrial Precision Division New Account
                        </p>
                    </div>
                    <form class="space-y-5" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative group @error('name') has-error @enderror">
                                ...
                                <input
                                    class="w-full bg-surface-container-low border border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary/20 rounded px-10 py-3 font-body text-sm placeholder:text-outline-variant transition-all outline-none @error('name') border-error @enderror"
                                    id="name" placeholder="John Doe" type="text" name="name" value="{{ old('name') }}"
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative group">
                                <span
                                    ...
                                    data-icon="lock">lock</span>
                                <input
                                    class="w-full bg-surface-container-low border border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary/20 rounded px-10 py-3 font-body text-sm placeholder:text-outline-variant transition-all outline-none"
